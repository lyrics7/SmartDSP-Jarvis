...
|---|---|---|---|---|---|
| **MMArt-PPR10K** | JarvisArt | Multimodal paired image-retouching dataset | PPR10K-based paired images, multi-granularity user instructions, and Lua/XMP-based Lightroom editing configurations | Research on instruction-driven agentic image retouching | [Dataset]\([https://huggingface.co/datasets/JarvisArt/MMArt-PPR10k](https://huggingface.co/datasets/JarvisArt/MMArt-PPR10k)) / [Paper]\([https://arxiv.org/abs/2506.17612](https://arxiv.org/abs/2506.17612)) |
| **MMArt-Bench** | JarvisArt | Multiscenario photo-retouching evaluation benchmark | 200 instances across 4 major scenarios + 50-image portrait subset with mask annotations | Comprehensive image-level and region-level evaluation of agentic photo-retouching systems | [Dataset]\([https://huggingface.co/datasets/JarvisArt/MMArt-Bench](https://huggingface.co/datasets/JarvisArt/MMArt-Bench)) / [Paper]\([https://arxiv.org/abs/2506.17612](https://arxiv.org/abs/2506.17612)) |
| **ArtEdit-Bench** | JarvisEvo | Image-editing evaluation benchmark | ArtEdit-Bench-Lr: 800 bilingual samples; ArtEdit-Bench-Eval: 200 English samples | Evaluating fine-grained retouching and model self-evaluation capabilities | [Dataset]\([https://huggingface.co/datasets/JarvisEvo/ArtEdit-Bench](https://huggingface.co/datasets/JarvisEvo/ArtEdit-Bench)) / [Paper]\([https://arxiv.org/abs/2511.23002](https://arxiv.org/abs/2511.23002)) |
| **CleanBench** | JarvisIR | Synthetic + real-world instruction-following image-restoration dataset | 150K synthetic + 80K real instruction-response pairs | Training and evaluating intelligent restoration systems under real-world adverse conditions | [Dataset]\([https://huggingface.co/datasets/LYL1015/CleanBench](https://huggingface.co/datasets/LYL1015/CleanBench)) / [Project]\([https://cvpr2025-jarvisir.github.io/](https://cvpr2025-jarvisir.github.io/)) / [Paper]\([https://lyl1015.github.io/papers/CVPR2025\_JarvisIR.pdf](https://lyl1015.github.io/papers/CVPR2025_JarvisIR.pdf)) |
---
<a id="mmart-ppr10k"></a>
## MMArt-PPR10K
...
### Links
[\*\*Dataset\*\*]\([https://huggingface.co/datasets/JarvisArt/MMArt-PPR10k](https://huggingface.co/datasets/JarvisArt/MMArt-PPR10k)) ·
[\*\*Paper\*\*]\([https://arxiv.org/abs/2506.17612](https://arxiv.org/abs/2506.17612)) ·
...
### Links
[\*\*Dataset\*\*]\([https://huggingface.co/datasets/JarvisArt/MMArt-Bench](https://huggingface.co/datasets/JarvisArt/MMArt-Bench)) ·
[\*\*Paper\*\*]\([https://arxiv.org/abs/2506.17612](https://arxiv.org/abs/2506.17612)) ·
[\*\*Project Page\*\*]\([https://jarvisart.vercel.app/](https://jarvisart.vercel.app/)) ·
**Code**
---
...
### Links
[\*\*Dataset\*\*]\([https://huggingface.co/datasets/JarvisEvo/ArtEdit-Bench](https://huggingface.co/datasets/JarvisEvo/ArtEdit-Bench)) ·
[\*\*Paper\*\*]\([https://arxiv.org/abs/2511.23002](https://arxiv.org/abs/2511.23002)) ·
[\*\*Project Page\*\*]\([https://jarvisevo.vercel.app/](https://jarvisevo.vercel.app/)) ·
**Code**
---
<a id="cleanbench"></a>
## CleanBench
...
### Links
[\*\*Dataset\*\*]\([https://huggingface.co/datasets/LYL1015/CleanBench](https://huggingface.co/datasets/LYL1015/CleanBench)) ·
[\*\*Project Page\*\*]\([https://cvpr2025-jarvisir.github.io/](https://cvpr2025-jarvisir.github.io/)) ·
[\*\*Paper\*\*]\([https://lyl1015.github.io/papers/CVPR2025\_JarvisIR.pdf](https://lyl1015.github.io/papers/CVPR2025_JarvisIR.pdf)) ·
**Code**
---
...
|---|---|---|---|---|---|
| 2026 | **JarvisHub: An Open Harness for Canvas-Native Multimodal Creative Agents** |Canvas-native multimodal creative-agent harness | Yunlong Lin et al. | Preprint / arXiv 2026 | [Project]\([https://www.jarvishub.site/](https://www.jarvishub.site/)) / [Paper]\([https://arxiv.org/abs/2607.23588](https://arxiv.org/abs/2607.23588)) / [Code](https://github.com/LYL1015/JarvisHub) / [HF]\([https://huggingface.co/papers/2607.23588](https://huggingface.co/papers/2607.23588)) |
| 2026 | **JarvisEvo: Towards a Self-Evolving Photo Editing Agent with Synergistic Editor-Evaluator Optimization** | Self-evolving photo-editing agent | Yunlong Lin et al. | CVPR 2026 | [Project]\([https://jarvisevo.vercel.app/](https://jarvisevo.vercel.app/)) / [Paper]\([https://arxiv.org/abs/2511.23002](https://arxiv.org/abs/2511.23002)) / [Code](https://github.com/LYL1015/JarvisEvo) / [HF]\([https://huggingface.co/papers/2511.23002](https://huggingface.co/papers/2511.23002)) |
| 2026 | **JarvisX-Cowork** | End-to-end creative-agent harness | — | Open-Source Project | Code / [Demo]\([https://youtu.be/SiNsTmGbWlo](https://youtu.be/SiNsTmGbWlo)) |
| 2025 | **JarvisArt: Liberating Human Artistic Creativity via an Intelligent Photo Retouching Agent** | MLLM-driven professional photo-retouching agent | Yunlong Lin et al. | NeurIPS 2025 | [Project]\([https://jarvisart.vercel.app/](https://jarvisart.vercel.app/)) / [Paper]\([https://arxiv.org/abs/2506.17612](https://arxiv.org/abs/2506.17612)) / [Code](https://github.com/LYL1015/JarvisArt) / [HF]\([https://huggingface.co/papers/2506.17612](https://huggingface.co/papers/2506.17612)) |
| 2025 | **JarvisIR: Elevating Autonomous Driving Perception with Intelligent Image Restoration** | VLM-powered intelligent image-restoration agent | Yunlong Lin et al. | CVPR 2025 | [Project]\([https://cvpr2025-jarvisir.github.io/](https://cvpr2025-jarvisir.github.io/)) / [Paper]\([https://lyl1015.github.io/papers/CVPR2025\_JarvisIR.pdf](https://lyl1015.github.io/papers/CVPR2025_JarvisIR.pdf)) / [Code](https://github.com/LYL1015/JarvisIR) / [Demo]\([https://huggingface.co/spaces/LYL1015/JarvisIR](https://huggingface.co/spaces/LYL1015/JarvisIR)) |
---
<a id="jarvishub"></a>
## JarvisHub
...
**Links:**  
[Project]\([https://www.jarvishub.site/](https://www.jarvishub.site/)) /
[Paper]\([https://arxiv.org/abs/2607.23588](https://arxiv.org/abs/2607.23588)) /
Code /
[Hugging Face]\([https://huggingface.co/papers/2607.23588](https://huggingface.co/papers/2607.23588))
### Highlights
...
**Links:**  
[Project]\([https://jarvisevo.vercel.app/](https://jarvisevo.vercel.app/)) /
[Paper]\([https://arxiv.org/abs/2511.23002](https://arxiv.org/abs/2511.23002)) /
[PDF]\([https://arxiv.org/pdf/2511.23002](https://arxiv.org/pdf/2511.23002)) /
Code /
[Hugging Face]\([https://huggingface.co/papers/2511.23002](https://huggingface.co/papers/2511.23002))
### Highlights
...
**Links:**  
Code /
[Demo Video]\([https://youtu.be/SiNsTmGbWlo](https://youtu.be/SiNsTmGbWlo))
### Highlights
...
**Links:**  
[Project]\([https://jarvisart.vercel.app/](https://jarvisart.vercel.app/)) /
[Paper]\([https://arxiv.org/abs/2506.17612](https://arxiv.org/abs/2506.17612)) /
Code /
[Hugging Face]\([https://huggingface.co/papers/2506.17612](https://huggingface.co/papers/2506.17612)) /
[YouTube]\([https://www.youtube.com/watch?v=Ol28DQj8wV8](https://www.youtube.com/watch?v=Ol28DQj8wV8)) /
[Bilibili]\([https://www.bilibili.com/video/BV1Sd3nzREvP](https://www.bilibili.com/video/BV1Sd3nzREvP))
### Highlights
...
**Links:**  
[Project]\([https://cvpr2025-jarvisir.github.io/](https://cvpr2025-jarvisir.github.io/)) /
[Paper]\([https://lyl1015.github.io/papers/CVPR2025\_JarvisIR.pdf](https://lyl1015.github.io/papers/CVPR2025_JarvisIR.pdf)) /
Code /
[Hugging Face Demo]\([https://huggingface.co/spaces/LYL1015/JarvisIR](https://huggingface.co/spaces/LYL1015/JarvisIR))
### Highlights
